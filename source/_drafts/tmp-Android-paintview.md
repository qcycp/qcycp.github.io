...
public class PaintView extends View {
    private final static String TAG = PaintView.class.getName();
    ...
    private static final float PAINT_RADIUS = 12f;
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        this.paths = (ArrayList) b.getSerializable("paths");
    }
    ...
    private class PaintPath implements Externalizable {
        ...
        public void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
            ...
            points = (ArrayList) objectInput.readObject();
        }
