...
#menu8 li a:link, #menu8 li a:visited {
     color: #777;
     display: block;
     background: url(./img/menu_icon.gif);
     padding: 1px 0 0 20px;
}
    
#menu8 li a:hover {
     color: #257EB7;
     background: url(./img/menu_icon.gif) 0 -32px;
     padding: 1px 0 0 25px;
}
    
#menu8 li a:active {
     color: #fff;
     background: url(./img/menu_icon.gif) 0 -64px;
     padding: 1px 0 0 25px;
}
...
```
menu圖片
![ab39745c14d4218da031c1be92b7fa9e.png](:/a05c29f8aedc449b81bd8c7748de4135)
