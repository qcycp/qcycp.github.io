...
gif ImageView
===
http://abhinavasblog.blogspot.tw/2014/04/animated-gif-imageview-library-for.html

使用方式1, 在layout中定義
Layout
```
<packagename.AnimatedGifImageView
...
animatedGifImageView.setAnimatedGif(R.drawable.cupcake, AnimatedGifImageView.TYPE.FIT_CENTER);
```

使用方式2, 在程式中動態宣告
```
private AnimatedGifImageView mAnimatedGifImageView;
mAnimatedGifImageView = new AnimatedGifImageView(this);
mAnimatedGifImageView.setAnimatedGif(R.drawable.loading, AnimatedGifImageView.TYPE.FIT_CENTER);
RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(width, height));
params.addRule(RelativeLayout.CENTER_IN_PARENT);
addView(mAnimatedGifImageView, params);
```

//AnimatedGifImageView.java
```
