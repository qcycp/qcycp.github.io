...
die
    "Usage: memcached-tool <host[:port] | /path/to/socket> [mode]\n
       memcached-tool localhost:11211 display        # shows slabs
       memcached-tool localhost:11211                # same.  (default is display)
       memcached-tool localhost:11211 stats          # shows general stats
       memcached-tool localhost:11211 settings       # shows settings stats
       memcached-tool localhost:11211 sizes          # shows sizes stats
       memcached-tool localhost:11211 dump [limit]   # dumps keys and values
